...
#  ::::    ::::: ::   :: ::::   ::   ::     :::: ::    ::: :::  ::   :::   ::   ::   ::   ::   :: ::::  ::   :::  
#   :       : :  :   : :: : :  ::    :      :: : :     :: :: :   :   : :  ::    :   ::    :   : :: ::    :   : : 
# Author     : Harper Ashelford
# Tool       : Vuln Scanner v1.2
...
#              This product is only intended for enterprise use. Any use for illegal purposes 
#              isnt liable to the Author.
# DISCLAIMER :
# © Harper Ashelford
...
# We may change these terms of use from time to time. Check before re-using any content from this product.
#
#
#
#
...
:!:  !!:  !!:  !!!  !!:       !!:  !!!          !:!  :!!       !!:  !!!  !!:  !!!  !!:  !!!  !!:       !!: :!!   
 ::!!:!   :!:  !:!   :!:      :!:  !:!         !:!   :!:       :!:  !:!  :!:  !:!  :!:  !:!  :!:       :!:  !:!  
  ::::    ::::: ::   :: ::::   ::   ::     :::: ::    ::: :::  ::   :::   ::   ::   ::   ::   :: ::::  ::   :::  
   :       : :  :   : :: : :  ::    :      :: : :     :: :: :   :   : :  ::    :   ::    :   : :: ::    :   : : 
                     """+bcolors.ENDC+"""(Multi-Tool Web Vulnerability Scanner)
    """
    print(logo_ascii)
    print(bcolors.ENDC)
...
class Spinner:
    ...
    def spinner_task(self):
        ...
        try:
            ...
            print("\n\t"+ bcolors.BG_ERR_TXT+"Vuln Scanner received a series of Ctrl+C hits. Quitting..." +bcolors.ENDC)
            sys.exit(1)
...
if args_namespace.help or (not args_namespace.update \
    ...
    logo()
    print("Vuln Scanner is updating....Please wait.\n")
    spinner.start()
    ...
    if oldversion_hash == newversion_hash :
        clear()
        print("\t"+ bcolors.OKBLUE +"You already have the latest version of Vuln Scanner." + bcolors.ENDC)
    else:
        clear()
        print("\t"+ bcolors.OKGREEN +"Vuln Scanner successfully updated to the latest version." +bcolors.ENDC)
    spinner.stop()
    sys.exit(1)
    ...
    while (rs_avail_tools < len(tools_precheck)):
        ...
        try:
            ...
            print("\t"+bcolors.BG_ERR_TXT+"Vuln Scanner was terminated abruptly..."+bcolors.ENDC)
            sys.exit(1)
